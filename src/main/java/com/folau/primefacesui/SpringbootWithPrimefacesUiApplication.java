package com.folau.primefacesui;
...
public class SpringbootWithPrimefacesUiApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringbootWithPrimefacesUiApplication.class, args);
	}
